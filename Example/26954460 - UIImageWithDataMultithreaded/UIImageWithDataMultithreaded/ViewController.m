...
- (void)viewDidLoad {
    ...
    NSURL *fileURL = [[NSBundle mainBundle] URLForResource:@"meme" withExtension:@"png"];
    NSData *data = [NSData dataWithContentsOfURL:fileURL];

    dispatch_apply(10000000, dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^(size_t idx) {
        @autoreleasepool {
